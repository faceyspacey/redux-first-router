...
createTest('callback "req" argument has all goodies', {
  SECOND: {
    ...
    beforeEnter: (req) => {
      ...
      expect(req.registerMiddleware).toBeDefined()
      expect(req.hasMiddleware).toBeDefined()
      ...
      expect(req.initialState).toBeDefined()
      expect(req.initialLocation).toMatchObject({ type: 'FIRST' })
